...
describe('InfluxDBReporter', function () {
  ...
  describe('assertion', function () {
    ...
    it('should update currentItem data for skipped assertion', function () {
      ...
      const args2 = { skipped: true, assertion: 'Test Assertion' };
      reporter.assertion(null, args2);
    ...
    it('should send data to service', function () {
      ...
      reporter.service = {
        sendData: function (data) {
          assert.ok(data.startsWith('test_measurement,'));
        }
      };

      reporter.item({ test: 'Test Assertion', name: 'AssertionError', message: 'Test failed' });
    });
  });
