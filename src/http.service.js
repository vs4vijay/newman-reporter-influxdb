...
class HttpService {
  ...
  async signIn() {
    ...
    try {
      ...
      console.log('[-] ERROR: while signing in to InfluxDB', error ? this.context.debug : error.message);
    }
  }
  ...
  async signOut() {
    ...
    try {
      ...
      console.log('[-] ERROR: while signing out to InfluxDB', error ? this.context.debug : error.message);
    }
  }
  ...
  async healthCheck() {
    ...
    try {
      ...
      console.log('[-] ERROR: not able to connect to InfluxDB', error ? this.context.debug : error.message);
    }
  }
